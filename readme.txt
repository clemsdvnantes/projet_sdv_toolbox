...
Suite à apporter :
1. Création d'un site html/css/js qui va lire les résultats et les présenter proprement (tableau/dashboard)
2. Changement de l'ensemble des scripts pour que les rapports csv et json se créé dans un dossier du nom de la cible
3. Ajout d'une boîte de dialogue graphique pour la saisie de l'ip/dns cible
4. ....
